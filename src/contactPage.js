function createContact() {
  ...
  if (!document.getElementById("contactFeed")) {
    ...
    contactInfoContainer.appendChild(createContactSection("75001 US-101", "Leggett, CA 95585, USA", "+123456789"));
    contactInfoContainer.appendChild(createContactSection("Monday-Thursday: 8:30am - 11pm", "Friday-Saturday: 9am - midnight", "Sunday: 9am - 10pm"));
